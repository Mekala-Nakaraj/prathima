                ...
                <li>
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">Sandbox</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>Sandbox Configuration</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                                    ...
                                    <div class="widget-header">
                                        <div class="row">
                                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                                <h4>Sanbox Configuration</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="widget-content widget-content-area">
                                        <form action="{{ route('settings.sanbox.store') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-lg-6 mb-4">
                                                    <label class="col-form-label">API Key</label>
                                                    <input type="text" class="form-control" id="razerpay_live_api_key"
                                                        name="sandbox_live_api_key"
                                                        value="{{ old('sandbox_live_api_key', $settings->where('key', 'sandbox_live_api_key')->first()->value ?? '') }}"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    ...
                                                    <input type="text" class="form-control" id="razerpay_live_api_key"
                                                        ...
                                                        value="{{ old('sandbox_secret_key', $settings->where('key', 'sandbox_secret_key')->first()->value ?? '') }}"
                                                ...
                                                <div class="col-lg-6 mb-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ old('sandbox_version', $settings->where('key', 'sandbox_version')->first()->value ?? '') }}"
                                                        placeholder="Enter sanbox version" required>
